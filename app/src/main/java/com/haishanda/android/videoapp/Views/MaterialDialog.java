    ...
    private class Builder {
        ...
        private Builder() {
            ...
            View contentView = LayoutInflater.from(mContext)
                    .inflate(me.drakeet.materialdialog.R.layout.layout_material_dialog, null);
            contentView.setFocusable(true);
            contentView.setFocusableInTouchMode(true);

            mAlertDialogWindow.setBackgroundDrawableResource(me.drakeet.materialdialog.R.drawable.material_dialog_window);

            mAlertDialogWindow.setContentView(contentView);

            mTitleView = (TextView) mAlertDialogWindow.findViewById(me.drakeet.materialdialog.R.id.title);
            mTitleView.setTextAlignment(View.TEXT_ALIGNMENT_CENTER);
            mTitleView.setGravity(Gravity.CENTER);
            mMessageView = (TextView) mAlertDialogWindow.findViewById(me.drakeet.materialdialog.R.id.message);
            mButtonLayout = (LinearLayout) mAlertDialogWindow.findViewById(me.drakeet.materialdialog.R.id.buttonLayout);
            mPositiveButton = (Button) mButtonLayout.findViewById(me.drakeet.materialdialog.R.id.btn_p);
            mNegativeButton = (Button) mButtonLayout.findViewById(me.drakeet.materialdialog.R.id.btn_n);
            mMessageContentRoot = (ViewGroup) mAlertDialogWindow.findViewById(
                    me.drakeet.materialdialog.R.id.message_content_root);
            if (mView != null) {
                LinearLayout linearLayout = (LinearLayout) mAlertDialogWindow.findViewById(
                        me.drakeet.materialdialog.R.id.contentView);
            ...
            if (mBackgroundResId != -1) {
                LinearLayout linearLayout = (LinearLayout) mAlertDialogWindow.findViewById(
                        me.drakeet.materialdialog.R.id.material_background);
        ...
        public void setPositiveButton(String text, final View.OnClickListener listener) {
            ...
            button.setBackgroundResource(me.drakeet.materialdialog.R.drawable.material_card);
        ...
        public void setView(View view) {
            LinearLayout l = (LinearLayout) mAlertDialogWindow.findViewById(me.drakeet.materialdialog.R.id.contentView);
            l.removeAllViews();
        ...
        public void setContentView(View contentView) {
            ...
            LinearLayout linearLayout = (LinearLayout) mAlertDialogWindow.findViewById(
                    me.drakeet.materialdialog.R.id.message_content_view);
